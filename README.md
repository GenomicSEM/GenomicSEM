...
**v0.0.5 Patch notes**: Moved small portion of userGWAS and commonfactorGWAS to C++ (see [patchnotes](PATCHNOTES.md)).  
**v0.0.5 Feature update**: `userGWAS()` and `commonfactorGWAS()` should now run faster.
